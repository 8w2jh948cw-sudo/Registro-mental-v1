/* Registro Mental Oficial 1.2.0-beta.31 — aparência segura, paleta fixa e últimos registros. */
(() => {
  'use strict';

  const RELEASE = '1.2.0-beta.31';
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      html[data-theme="dark"] .rm-v28-timeline.rm-type-purchase .rm-purchase-price{color:#4AD968!important}
      @media(prefers-color-scheme:dark){html[data-theme="system"] .rm-v28-timeline.rm-type-purchase .rm-purchase-price{color:#4AD968!important}}
...
(() => {
  try {
    ...
    script.src = `./mood-bar-v2.js?v=1.2.0-beta.31&load=${Date.now()}`;
    script.async = true;
