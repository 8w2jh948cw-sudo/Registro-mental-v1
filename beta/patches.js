...
(() => {
  ...
  const RELEASE = String(window.REGISTRO_SHELL_RELEASE || '1.2.0-beta.25');
...
(() => {
  ...
  function validateBackup(parsed) {
    ...
    if (format > MAX_BACKUP_FORMAT) throw new Error(`Este backup usa o formato ${format}. A Oficial 1.2.0-beta.25 entende até o formato ${MAX_BACKUP_FORMAT}. Use um “Backup para Oficial estável” criado pela Beta.`);
